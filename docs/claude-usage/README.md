...
- **Generated:** 2026-09-15T17:44:21Z (UTC)
- **Window:** last 7 day(s), turns dated >= 2026-09-08
- **Transcripts scanned:** 1,846 files (0 unreadable), 90,254 assistant turns in window
- **Estimated list-price cost of tokens consumed:** $30,269.02
...
|---|---|---|---|
| Top-tier (Fable/Opus) share of spend | 72.0% | <= 30.0% | **OVER** |
| Avg cache-read tokens per top-tier turn | 353,746 | <= 200,000 | **OVER** |
...
|---|---|---|---|---|---|---|---|
| top | 27,533 | 200,579 | 27,477,740 | 9,739,684,877 | 273,636,963 | $21,804.06 | 72.0% |
| sonnet | 62,534 | 125,068 | 16,499,917 | 23,646,298,048 | 298,881,518 | $8,462.57 | 28.0% |
| haiku | 110 | 910 | 16,527 | 7,200,400 | 1,267,739 | $2.39 | 0.0% |
| other | 77 | 0 | 0 | 0 | 0 | $0.00 | 0.0% |

Main loop $16,057.18 (53.0%) vs subagents $14,211.84 (46.9%). Avg cache-read per top-tier turn: 353,746.
...
| c--code-ADA | `4c34cb26` | $1,715.04 | 5,067 | sonnet 4186, top 860, other 21 |
| c--code-ADA | `802d7e67` | $1,710.80 | 8,933 | sonnet 8230, top 693, other 10 |
| c--code-ADA | `e6f55a63` | $1,707.34 | 5,234 | sonnet 4183, top 1045, other 6 |
...
|---|---|---|---|---|
| 2026-09-15 | $30,269.02 | 72.0% | 353,746 | 41.4% |
